...
# Replace the LinearLayout for Quick Access
bar_regex = r'<LinearLayout\s+android:id="@+id/llQuickAccessBar".*?</LinearLayout>'

new_bar = '''<LinearLayout
...
xml = re.sub(bar_regex, new_bar, xml, flags=re.DOTALL)

with open('app/src/main/res/layout/activity_main.xml', 'w', encoding='utf-8') as f:
    f.write(xml)

print("Fixed Quick Access Bar XML completely")
